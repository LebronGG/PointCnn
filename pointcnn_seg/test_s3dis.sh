...
#CUDA_VISIBLE_DEVICES=$gpu python3 ../test_general_seg.py -t ../../data/S3DIS/val_files_Area_$area.txt -f ../../data/S3DIS/Area_${area}/ -l $ckpt -m pointcnn_seg -x $setting -r $repeat $save_ply
